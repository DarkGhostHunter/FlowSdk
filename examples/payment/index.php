...
if ($_POST['payment'] ?? null) {
    ...
    $response = $flow->payment()->commit($_POST['payment']);
...
<h1>Payment</h1>
<p>Let's create a payment information and commit it:</p>
...
<form method="POST" class="card card-body">
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <select id="paymentMethod" class="custom-select" name="payment[paymentMethod]">
                <option value="9" selected>All payment methods</option>
                <option value="1">Webpay</option>
                <option value="2">Servipag</option>
                <option value="3">Multicaja</option>
                <option value="5">Onepay</option>
                <option value="8">Cryptocompra</option>
            </select>
            <small class="input-text text-black-50">If it's not *all*, use won't be allowed to select other payment method.</small>
        </div>
        ...
        <div class="form-group col-md-12">
            ...
            <small class="input-text text-black-50">Where the user will return.</small>
        </div>
